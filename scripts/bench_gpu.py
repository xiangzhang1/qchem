...
with open("/home/xzhang1/m_gpu_config.log", "w") as of_:
    of_.write('%15s %15s %15s %15s %15s %15s %15s %15s %15s %15s\n' %('proj_real','proj_reci', 'npar', 'wavef', 'kpar', 'arraygrid', 'ncore_total', 'cpu_est_mem', 'real_mem', 'ele_time'))
    ...
    for prec in ['Accurate','Normal','Low']:
        for kpar in [1, 2, 4, 8]:
            for encut in [200, 300, 400]:
                ...
                ncore=1, ncore_node=1, prec=%s, encut=%s, lreal=On, kpar=%s, kpoints=G 2 2 2,
